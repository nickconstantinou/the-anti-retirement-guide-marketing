      ...
      <div className="max-w-5xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <Link 
              href="/jumpstart" 
              className="bg-gradient-to-r from-amber-400 to-amber-500 text-slate-900 px-5 py-2.5 rounded-full font-semibold hover:from-amber-500 hover:to-amber-400 transition-all"
            >
              Free Guide
            </Link>
          </div>
            ...
            <div className="flex flex-col gap-4">
              {navLinks.map((link) => (
                <Link 
                  key={link.href} 
                  href={link.href} 
                  className="text-lg hover:text-amber-400 transition-colors py-2"
